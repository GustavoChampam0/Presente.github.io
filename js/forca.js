...
function criarPalavraSecreta(){
    palavraSecretaSorteada = "LASANHA";  // Palavra fixa "LASANHA"
    palavraSecretaCategoria = "Dica: A primeira comida que comemos juntos";  // Categoria fixa
}
...
function carregaListaAutomatica(){
    palavras = [
        palavra001 = {
            nome: "LASANHA",  // Palavra fixa "LASANHA"
            categoria:"Dica: A primeira comida que comemos juntos"
        }
    ];
}
